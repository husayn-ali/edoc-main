...
<head>
    ...
    .btn-primary {
        background-color: #FF9800; /* Change to desired primary color */
        color: white;
    }

    .btn-primary-soft {
        background-color: #FF9800; /* Change to desired soft color */
        color: white;
    }

    .btn-primary:hover, .btn-primary-soft:hover {
        background-color: #e68900; /* Change hover color */
    }

    .btn-back {
        background-color: #4CAF50; /* Change to desired back button color */
        color: white;
    }

    .btn-search {
        background-color: #4CAF50; /* Change to desired search button color */
        color: white;
    }

    .btn-add-new {
        background-color: #4CAF50; /* Change to desired add new button color */
        color: white;
    }
    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%">
                        <a href="index.php" ><button  class="login-btn btn-back btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
...
?>
                            ...
                            <input type="Submit" value="Search" class="login-btn btn-search btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                ...
                <tr >
                    ...
                    <td colspan="2">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="login-btn btn-add-new btn button-icon"  style="display: flex;justify-content: center;align-items: center;margin-left:75px;background-image: url('../img/icons/add.svg');">Add New</font></button>
                            </a></td>
                </tr>
                <tr>
