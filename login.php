            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <h2 class="text-center">Doctor Appoiment Managment System</h4>
                  <img src="assets/images/logo.svg.png"> 
                </div>
                <h4>Aan bilaabno</h4>
                <h6 class="font-weight-light">"Soo gal si aad u sii wadato".</h6>
                <form class="pt-3" method="POST">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="signup.php" class="text-primary">Register</a>
                  </div>
                </form>
              </div>
            </div>
